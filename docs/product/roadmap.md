...
| Phase 1E        | Child play UX              | #8  | Correct/incorrect feedback, completion panel, dan map progress UX   |
...
| Phase 1H        | Child profile lifecycle    | -   | Gated update, soft-delete, retained history, dan concurrency safety |
