...
| Child Profile core flow                    | Implemented | Create/list/read/update/soft-delete UI dan APIs, parent gate, ownership, audit, permission/security/concurrency tests  | MVP tetap satu active child                                 |
| Child update/delete                        | Implemented | Gated partial update dan soft-delete dengan advisory locks, sanitized audit, serta retained learning history           | Restore dan deleted-child UI tidak tersedia                 |
